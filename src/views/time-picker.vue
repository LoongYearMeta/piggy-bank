          ...
          <div class="el-tab-pane" v-if="activeTab === 'date'">
            ...
            <div class="el-date-table">
              <div class="el-date-table__header">
                <span v-for="week in weekDays" :key="week" class="el-date-table__cell">{{ week }}</span>
              </div>
              ...
              <div class="el-time-panel__content">
                ...
                <div class="time-select-group">
                  ...
                  <div class="time-select-item">
                    ...
                    <div class="el-time-spinner__wrapper" @wheel="(e) => handleTimeScroll(e, 'hour')" @touchmove.prevent="handleTouchScroll($event, 'hour')">
                  ...
                  <div class="time-select-item">
                    ...
                    <div class="el-time-spinner__wrapper" @wheel="(e) => handleTimeScroll(e, 'minute')" @touchmove.prevent="handleTouchScroll($event, 'minute')">
                  ...
                  <div class="time-select-item">
                    ...
                    <div class="el-time-spinner__wrapper" @wheel="(e) => handleTimeScroll(e, 'second')" @touchmove.prevent="handleTouchScroll($event, 'second')">
...
const handleTimeScroll = (e: WheelEvent, type: 'hour' | 'minute' | 'second') => {
  ...
  const list = type === 'hour' ? hourList.value : type === 'minute' ? minuteList.value : secondList.value
...
const handleBlur = () => { if (!isPanelShow.value) isFocused.value = false }
...
@keyframes elZoomInAbove { 0% { opacity: 0; transform: scale(0.95) translateY(5px); } 100% { opacity: 1; transform: scale(1) translateY(0); } }
.el-picker-panel[style*="bottom: 100%"] { animation: elZoomInAbove 0.2s cubic-bezier(0.23, 1, 0.32, 1); }

/* 标签页样式 */
.el-tabs { width: 100%; }
.el-tabs__nav { display: flex; border-bottom: 1px solid #e4e7ed; margin-bottom: 12px; padding: 0 8px; }
.el-tabs__item {
  padding: 8px 12px;
  margin-right: 20px;
  font-size: 14px;
...
.el-tabs__item.is-active { color: #409eff; font-weight: 500; }
...
.el-tab-pane { width: 100%; box-sizing: border-box; }

/* 日期面板样式 */
.el-picker-panel__header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px; padding: 0 8px; }
...
.el-picker-panel__icon-btn:hover { background-color: #f5f7fa; }
.el-picker-panel__label { font-size: 14px; font-weight: 500; color: #303133; }

/* 日期表格 */
.el-date-table { width: 100%; margin: 0 auto; max-width: 280px; }
.el-date-table__header, .el-date-table__body { display: flex; flex-wrap: wrap; }
.el-date-table__cell {
  flex: 0 0 calc(100% / 7);
  height: 36px;
  line-height: 36px;
...
.el-date-table__header .el-date-table__cell { color: #909399; font-weight: 500; cursor: default; }
.el-date-table__cell--disabled { color: #c0c4cc; cursor: not-allowed; }
.el-date-table__cell--today { color: #409eff; font-weight: 500; }
...
/* 时间选择组：统一包裹时/分/秒区域 */
.time-select-group { display: flex; align-items: flex-start; gap: 6px; }
...
/* 动画效果 */
@keyframes elZoomIn { 0% { opacity: 0; transform: scale(0.95); } 100% { opacity: 1; transform: scale(1); } }
@keyframes fadeIn { from { opacity: 0; transform: translateY(5px); } to { opacity: 1; transform: translateY(0); } }
.error-fade-enter-from { opacity: 0; transform: translateY(-5px); }
.error-fade-enter-active { transition: all 0.3s ease; }
.error-fade-enter-to { opacity: 1; transform: translateY(0); }
.block-fade-enter-from { opacity: 0; transform: translateY(5px); }
.block-fade-enter-active { transition: all 0.3s ease; }
.block-fade-enter-to { opacity: 1; transform: translateY(0); }
...
@media (max-width: 480px) {
  ...
  .el-time-spinner__list li { font-size: 13px; }
  .el-time-spinner__separator { 
    padding-top: 82px; 
    font-size: 14px;
  }
  .el-tabs__item { padding: 6px 8px; margin-right: 12px; font-size: 13px; }
  .block-result {
    font-size: 13px;
    padding: 4px 6px;
  }
