...
.guide__toggle:hover { transform: translateY(-1px); box-shadow: var(--shadow-md); }
.guide__toggle:active { transform: translateY(0); }

.chevron { width: 18px; height: 18px; color: #666; transition: transform 0.2s ease; }
.chevron.rotate { transform: rotate(180deg); }

.guide__body { margin-top: 12px; overflow: hidden; }

.guide__header { text-align: center; margin-bottom: 10px; }
.guide__title { margin: 0; color: var(--color-text-primary); font-size: 22px; font-weight: 700; }
.guide__tagline { margin: 6px 0 0 0; color: var(--color-text-secondary); font-size: 14px; }

.guide__content { margin-top: 12px; text-align: left; }
...
.guide__subtitle { margin: 0 0 6px 0; color: var(--color-text-primary); font-size: 16px; }
.guide__list { margin: 0; padding-left: 18px; color: var(--color-text-primary); }
.guide__list li { margin: 6px 0; line-height: 1.6; }
.guide__list--notice { padding-left: 18px; }
...
.guide-collapse-leave-active {
  transition: max-height 500ms ease, opacity 600ms ease;
}
...
@media (max-width: 480px) {
  .guide { padding: var(--spacing-md); }
  .guide__title { font-size: 20px; }
  .guide__subtitle { font-size: 15px; }
  .guide__tagline { font-size: 13px; }
}
</style>
